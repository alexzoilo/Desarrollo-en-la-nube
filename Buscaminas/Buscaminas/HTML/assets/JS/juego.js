...
// Este valor viene del login de tu app
...
async function iniciarJuego(dificultad) {
  ...
  juego = new Buscaminas(usuarioActual, filas, columnas, Dificultad[dificultad]);

  // Guardar partida en la DB
...
async function login(nombre, password) {
  ...
  usuarioActual = data.id; // ✅ Guardamos el UUID
